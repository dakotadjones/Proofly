...
export default function PDFGenerator({ jobData, onNewJob, onPDFGenerated }: PDFGeneratorProps) {
  ...
  const emailPDF = async (uri: string) => {
    try {
      ...
      await MailComposer.composeAsync({
        recipients: jobData.clientEmail ? [jobData.clientEmail] : [],
        subject: `Service Completion Report - ${jobData.serviceType}`,
        body: `Dear ${jobData.clientName},\n\nPlease find attached the completion report for your recent ${jobData.serviceType} service.\n\nThank you for your business!`,
        attachments: [uri],
      });
    } catch (error) {
          ...
          <>
            ...
            <View style={styles.shareSection}>
              <View style={styles.successIndicator}>
                ...
                <Text style={styles.successSubtext}>Your report has been generated successfully</Text>
              </View>
              
              <Text style={styles.shareSectionTitle}>Share Your Report</Text>
              <View style={styles.pdfActions}>
                ...
                <TouchableOpacity style={styles.actionButton} onPress={() => pdfUri && emailPDF(pdfUri)}>
